...
public class OverworldBiomeBuilder {
	...
	protected ResourceKey<Biome> pickCoastWindSweptBiome(int temperatureIndex, int humidityIndex, Parameter weirdness) {
		if (weirdness.max() < 0) {
			ResourceKey<Biome> biome = COAST_WINDSWEPTS[temperatureIndex][humidityIndex];
			return biome != null ? biome : DEFERRED_PLACEHOLDER;
		} else {
			ResourceKey<Biome> biomeVariant = COAST_WINDSWEPTS_VARIANT[temperatureIndex][humidityIndex];
			ResourceKey<Biome> biome = COAST_WINDSWEPTS[temperatureIndex][humidityIndex];
			if (biomeVariant != null) return biomeVariant;
			if (biome != null) return biome;
			return DEFERRED_PLACEHOLDER;
	...
	protected ResourceKey<Biome> pickInlandWindSweptBiome(int temperatureIndex, int humidityIndex, Parameter weirdness) {
		if (weirdness.max() < 0) {
	...
	protected void addValley(Consumer<Pair<ParameterPoint, ResourceKey<Biome>>> mapper, Parameter weirdness) {
		for (int temperatureIndex = 0; temperatureIndex < 5; temperatureIndex++) {
			for (int humidityIndex = 0; humidityIndex < 5; humidityIndex++) {
				...
				// FarInland
				addValleyBiomes(mapper, pickBadlandBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.FAR_INLAND.parameter(), Erosion.span(Erosion.EROSION_0, Erosion.EROSION_1));
	...
	protected void addLow(Consumer<Pair<ParameterPoint, ResourceKey<Biome>>> mapper, Parameter weirdness) {
		for (int temperatureIndex = 0; temperatureIndex < 5; temperatureIndex++) {
			for (int humidityIndex = 0; humidityIndex < 5; humidityIndex++) {
				...
				addLowBiomes(mapper, pickCoastWindSweptBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.COAST.parameter(), Erosion.EROSION_5.parameter(), weirdness);
				...
				// NearInland
				addLowBiomes(mapper, pickBadlandBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.NEAR_INLAND.parameter(), Erosion.span(Erosion.EROSION_0, Erosion.EROSION_1), weirdness);
				...
				addLowBiomes(mapper, pickInlandWindSweptBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.NEAR_INLAND.parameter(), Erosion.EROSION_5.parameter(), weirdness);
				...
				// MidInland
				addLowBiomes(mapper, pickSlopeBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.MID_INLAND.parameter(), Erosion.span(Erosion.EROSION_0, Erosion.EROSION_1), weirdness);
				addLowBiomes(mapper, pickBadlandBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.MID_INLAND.parameter(), Erosion.span(Erosion.EROSION_2, Erosion.EROSION_3), weirdness);
				...
				addLowBiomes(mapper, pickSwampBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.MID_INLAND.parameter(), Erosion.EROSION_6.parameter(), weirdness);
				// FarInland
				addLowBiomes(mapper, pickSlopeBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.FAR_INLAND.parameter(), Erosion.span(Erosion.EROSION_0, Erosion.EROSION_1), weirdness);
				addLowBiomes(mapper, pickBadlandBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.FAR_INLAND.parameter(), Erosion.span(Erosion.EROSION_2, Erosion.EROSION_3), weirdness);
				...
				addLowBiomes(mapper, pickSwampBiome(temperatureIndex, humidityIndex, weirdness), temperature, humidity, Continentalness.FAR_INLAND.parameter(), Erosion.EROSION_6.parameter(), weirdness);
			}
		}
	}
